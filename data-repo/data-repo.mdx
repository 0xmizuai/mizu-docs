...
We bootstrap data repositories by importing existing open-source datasets into our platform. The repositories imported by MIZU are referred to as Meta Repositories, serving as the foundational data sources for other repositories within the network. In the future, users will have the capability to create and maintain their own specialized data repositories. All data operations within these repositories are processed by our decentralized data processing network.

<img
  className="block dark:hidden"
  src="/images/data-repo.png"
  alt="Hero Light"
/>
